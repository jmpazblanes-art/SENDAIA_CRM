...
export default function AppointmentReminderEmail({
    ...
    return (
        <Html>
            <Head />
            <Preview>Recordatorio: Tienes una cita mañana — {date} a las {time}</Preview>
                ...
                <Container style={{ maxWidth: '600px', margin: '0 auto', padding: '40px 20px' }}>
                    ...
                    <Section style={{ backgroundColor: '#111111', borderRadius: '12px', padding: '32px', marginBottom: '16px' }}>
                        ...
                        <Text style={{ margin: '0 0 24px 0', color: '#cccccc', fontSize: '15px', lineHeight: '1.7' }}>
                            Hola {name}, te recordamos que mañana tienes una cita programada con SendaIA.
                        </Text>
                        ...
                        <Text style={{ margin: '0', color: '#999999', fontSize: '13px', lineHeight: '1.6' }}>
                            Si no puedes asistir, por favor avísanos con antelación escribiendo a{' '}
